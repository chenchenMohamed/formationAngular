...
@Component({
  selector: 'app-list-inscription-etudiant',
  templateUrl: './list-inscription-etudiant.component.html',
  styleUrls: ['./list-inscription-etudiant.component.scss']
})
export class ListInscriptionEtudiantComponent implements OnInit {
  ...
  getFormations(idEtudiant){
    ...
    this.http.post(this.userService.baseURL+"/etudiantFormation/listInscriptionsEtudiant/"+idEtudiant, request, 
    {
      headers: {
